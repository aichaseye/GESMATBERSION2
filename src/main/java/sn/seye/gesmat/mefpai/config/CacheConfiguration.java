...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, sn.seye.gesmat.mefpai.domain.Localisation.class.getName());
            createCache(cm, sn.seye.gesmat.mefpai.domain.Localisation.class.getName() + ".etablissements");
